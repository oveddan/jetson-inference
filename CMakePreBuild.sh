...
mkdir -p ../data/networks/gaze-capture/

wget --no-check-certificate 'https://raw.githubusercontent.com/CSAILVision/GazeCapture/master/models/itracker_deploy.prototxt'
mv itracker_deploy.prototxt ../data/networks/gaze-capture/
wget --no-check-certificate 'https://github.com/CSAILVision/GazeCapture/raw/master/models/snapshots/itracker25x_iter_92000.caffemodel'
mv itracker25x_iter_92000.caffemodel ../data/networks/gaze-capture/

wget --no-check-certificate 'https://github.com/CSAILVision/GazeCapture/raw/master/models/mean_images/mean_face_224.mat'
wget --no-check-certificate 'https://github.com/CSAILVision/GazeCapture/raw/master/models/mean_images/mean_left_224.mat'
